...
namespace FormCont
{
    ...
    public partial class ControleEstoque : Form
    {
        ...
        public ControleEstoque()
        {
            ...
            toolTip.SetToolTip(btnListar, "Listar mercadorias");
            toolTip.SetToolTip(btnEditar, "Editar mercadoria selecionada");
            toolTip.SetToolTip(btnDeletar, "Excluir mercadoria selecionada");
            toolTip.SetToolTip(btnBuscar, "Buscar uma mercadoria");
            toolTip.SetToolTip(btnLimpar, "Limpar");
